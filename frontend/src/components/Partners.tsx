...
export default function Partners() {
  ...
  return (
    <section ref={ref} className="scroll-reveal" style={{ padding: "60px 24px", borderTop: "1px solid rgba(255,255,255,0.06)", borderBottom: "1px solid rgba(255,255,255,0.06)", background: "linear-gradient(180deg, rgba(5,5,5,0) 0%, rgba(17,17,17,0.3) 50%, rgba(5,5,5,0) 100%)" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, flexWrap: "wrap" }}>
          {partners.map((p, i) => (
            <div key={p.name} className={`scroll-reveal scroll-reveal--delay-${Math.min(i + 1, 5)}`} style={{ display: "flex", alignItems: "center", gap: 10, padding: "14px 28px", borderRadius: 14, background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", cursor: "default", transition: "all 0.3s ease" }}
